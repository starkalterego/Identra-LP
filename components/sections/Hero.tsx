    ...
    return (
        <section ref={containerRef} className="relative h-screen w-full flex items-center overflow-hidden bg-background">
            ...
            >
                ...
                {/* User Requested Hero Background Stack */}
                <div className="absolute inset-0 overflow-hidden">
                    {/* Soft animated gradient - INTENSIFIED */}
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(79,209,197,0.5),transparent_60%)] animate-pulse-slow mix-blend-screen" />

                    {/* Secondary Accent Blob - NEW */}
                    <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-blue-500/10 blur-[100px] rounded-full animate-drift mix-blend-screen opacity-60" />

                    {/* Subtle diagonal noise (Data URI fallback for noise.png) - SHARPER */}
                    <div
                    ...
                    {/* Slow drifting mask - MORE CONTRAST */}
                    <div className="absolute inset-0 bg-gradient-to-br from-transparent via-black/40 to-transparent animate-drift" />
                </div>
